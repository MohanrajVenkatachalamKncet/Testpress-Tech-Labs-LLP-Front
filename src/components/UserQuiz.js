...
export default function UserQuiz() { 
    ...
    const formValidation=()=>{
        if((quizId=="Enter your Quiz id or Code")){
            alert("Enter Your Quiz Id or Code or Title");
        }
        else{
            setValidation('')
        }
    ...
    return (
        ...
        <header>
        <p className="text-center p-css">Welcome <span style={{color:'red'}}>{userName}</span> to Quiz Assesment</p>
        <p className="text-center p-css">Search Your Assesment Here !!</p>
        <div className="p-1 col-12">
           <div className="form-group">
                <label for="exampleInputPassword1">Quiz Id or title</label>
